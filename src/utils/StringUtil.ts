...
export const getTimeTipText = (time: number, totalTime: number) => {
    // console.log(`getTimeTipText :time: ${time} totalTime: ${totalTime} +0:05 (0:35)`);
...
export const getForwardOrRewindTimeTipText = (symbol: string, minTime: number, maxTime: number) => {
    //console.log(`getForwardOrRewindTimeTipText :forwardOrRewindTime: ${forwardOrRewindTime} Time: ${time}`);
